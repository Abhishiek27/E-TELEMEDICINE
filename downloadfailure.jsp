  ...
  <div class="content">
    <div class="content_resize">
      <div class="sidebar"><div class="gadget">
          ...
          <ul class="sb_menu">
            <li><span class="style1"><span class="style2"><span class="style3"><a href="patientpage.jsp">Patients Home</a></span></span></span></li>
        ...
        <div class="article">
          ...
          <form id="form1" name="form1" method="post" action="HospitalLogin">
            ...
            <table width="360" height="216" border="0" align="center">
              ...
              <tr>
                <td><div align="center" class="style7"><a href="downloadrecords.jsp" class="style12"><span class="style8">Download Failed...! <br />
                </span> </a></div></td>
              </tr>
            </table>
            <p>&nbsp;</p>
