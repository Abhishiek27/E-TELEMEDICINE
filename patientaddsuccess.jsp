      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li class="style3"><span class="style2"><a href="addpatients.jsp">Add Patients </a></span></li>
        ...
        <div class="article">
          ...
          <form id="form1" name="form1" method="post" action="ServerLogin">
            <table width="490" height="173" border="0" align="center">
              <tr>
                <td><div align="center">
                    <label><span class="style14"><span class="style13">Patient  Details Added Successfully..!!!</span> </span></label>
                </div></td>
              </tr>
              <tr>
                <td><div align="center" class="style7"><span class="style9"><a href="hospitallogin.jsp"></a></span></div></td>
              </tr>
            </table>
          </form>
        </div>
