      ...
      <div class="mainbar">
        <div class="article">
          ...
          <form id="form1" name="form1" method="post" action="HospitalLogin">
            <p>&nbsp;</p>
            <table width="360" height="222" border="0" align="center">
              
              <tr>
                <td height="44"><div align="center" class="style7"><a href="addpatients.jsp" class="style12">ADD PATIENTS DETAILS </a></div>                  <label></label></td>
              </tr>
              <tr>
                <td height="50"><div align="center" class="style7"><a href="viewpatients.jsp" class="style12">VIEW PATIENTS DETAILS </a></div></td>
              </tr>
              <tr>
                <td height="69"><div align="center" class="style7"><a href="uploadrecords.jsp" class="style12">UPLOAD MEDICAL RECORDS </a></div></td>
              </tr>
              <tr>
                <td><div align="center" class="style7"><a href="access.jsp" class="style12">ACCESS OTHER HOSPITAL PATIENT DETAILS  </a></div></td>
              </tr>
            </table>
            <p>&nbsp;</p>
          </form>
