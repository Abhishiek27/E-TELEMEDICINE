    ...
    <div class="content_resize">
      ...
      <div class="entry">
        ...
        <form action="viewpatients1.jsp" method="post" name="myForm" id="myForm" onsubmit="return check();">
          <table width="607" border="0" align="left">
            <tr>
              <td width="136">&nbsp;</td>
              <td width="190"><div align="center">Search Patients </div></td>
              <td width="267"><label>
		...
		Statement st,st1,st2,st3,st4;
                                      ...
                                      Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/ehealthcloud","root","password");
                                            String query = "select * from uploadlist where patientid='"+user1+"' && hospitalid='"+hospitalid+"'"; 
		...
		Statement st,st1,st2,st3,st4;
                                            ...
                                            Class.forName("com.mysql.jdbc.Driver");
                                      Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/ehealthcloud","root","password");
                                            String query = "select * from patientdetails where username = '"+username+"'&& hospitalid='"+hospitalid+"'"; 
                                            st = con.createStatement();
                                            rs = st.executeQuery(query);
