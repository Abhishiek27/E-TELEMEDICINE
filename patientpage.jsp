      ...
      <div class="mainbar">
        <div class="article">
          ...
          <form id="form1" name="form1" method="post" action="HospitalLogin">
            <p>&nbsp;</p>
            <table width="360" height="216" border="0" align="center">
              
              <tr>
                <td height="80"><div align="center" class="style7"><a href="viewpatientdetails.jsp" class="style12">VIEW PATIENTS DETAILS </a></div></td>
              </tr>
              <tr>
                <td><div align="center" class="style7"><a href="downloadrecords.jsp" class="style12">DOWNLOAD MEDICAL RECORDS </a></div></td>
              </tr>
            </table>
            <p>&nbsp;</p>
          </form>
